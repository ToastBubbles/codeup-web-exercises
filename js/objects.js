(function() {
    ...
    shoppers.forEach(shopper => {
        //person.push({firstName: shopper.name, amount: shopper.amount})

        console.log(`${shopper.name} spent ${shopper.amount}! Their total after discount is ${applyDiscount(shopper.amount)}`)
    })
